...
const ManageGroups = () => {
  ...
  return (
    <div className="h-screen w-full p-6 bg-gray-50 overflow-auto">
      <CSSTransition
        nodeRef={overlayRef}
        in={showOverlay}
        timeout={300}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-8 slide-in-bottom">
          <h2 className="text-2xl font-bold text-gray-800 mb-2">
            Manage Mentor Groups
          </h2>
          <p className="text-gray-600">
            Assign mentees to mentors and manage existing groups
          </p>
        </div>

        {/* Stats and search section */}
        <div
          className="w-full mb-8 flex flex-col md:flex-row items-start md:items-center justify-between gap-4 slide-in-bottom"
