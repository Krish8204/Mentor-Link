...
const Profile = ({ profileData }) => {
  ...
  const [hiddenProfilePicDelModal, setHiddenProfilePicDelModal] =
    useState(false);
    ...
    if (role === Roles.MENTOR) {
      ...
      setStuProfileData({
        ...
        guardian_ph_no: profileData.guardian_ph_no
          ? profileData.guardian_ph_no
          : "",
        guardian_address: profileData.guardian_address
          ? profileData.guardian_address
          : "",
  ...
  const getCardTransitionClass = (index) => {
    return cardLoaded
      ? `opacity-100 translate-y-0 transition-all duration-500 ease-out delay-${
          index * 100
        }`
  ...
  const getContentTransitionClass = (index) => {
    return contentLoaded
      ? `opacity-100 translate-x-0 transition-all duration-300 ease-out delay-${
          index * 75
        }`
  ...
  return (
    <div
      className={`w-full h-full overflow-auto ${
        role === Roles.MENTOR ? "flex items-center justify-center" : "p-4"
      } 
    ...
    >
      ...
      {role === Roles.MENTOR && (
        <div className="w-3/5 max-w-5xl">
          <div
            className={`text-3xl font-bold text-gray-800 mb-8 ${getContentTransitionClass(
              0
            )}`}
          >
            Profile Dashboard
          ...
          <div className="flex gap-x-6 mb-6">
            <div
              className={`bg-white px-6 py-8 shadow-lg rounded-xl flex-shrink-0 border border-gray-100 ${getCardTransitionClass(
                1
              )}`}
            >
              <h3 className="mb-6 text-lg font-semibold text-gray-700 border-b pb-2 flex items-center">
                ...
                <UserCircleIcon
                  alt={false}
                  myStyle={"h-5 w-5 ml-2 text-blue-500"}
                />
              </h3>
            ...
            <div
              className={`bg-white p-6 rounded-xl shadow-lg flex-grow border border-gray-100 ${getCardTransitionClass(
                2
              )}`}
            >
              <h3 className="mb-6 text-lg font-semibold text-gray-700 border-b pb-2 flex items-center">
              ...
              <div className="grid grid-cols-3 gap-6">
                <div
                  className={`flex flex-col ${getContentTransitionClass(1)}`}
                >
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(2)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Middle Name
                  </span>
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(3)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Last Name
                  </span>
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(4)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Phone No.
                  </span>
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(5)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Address
                  </span>
              ...
              <div
                className={`flex flex-col mt-6 ${getContentTransitionClass(6)}`}
              >
          ...
          <div
            className={`bg-white p-6 rounded-xl shadow-lg border border-gray-100 ${getCardTransitionClass(
              3
            )}`}
          >
            <h3 className="mb-6 text-lg font-semibold text-gray-700 border-b pb-2 flex items-center">
            ...
            <div className="flex items-end justify-between">
              <div className="grid grid-cols-2 gap-6 w-full">
                <div
                  className={`flex flex-col ${getContentTransitionClass(7)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Department
                  </span>
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(8)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Designation
                  </span>
                ...
                <div
                  className={`flex flex-col ${getContentTransitionClass(9)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Assigned
                  </span>
                  <span className="text-gray-800 font-medium mt-1">
                    {profileData?.assigned || "—"}
                  </span>
                </div>
                <div
                  className={`flex flex-col ${getContentTransitionClass(10)}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                    Students under you
                  </span>
            ...
            <div className="col-span-12 md:col-span-4 space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-1 gap-y-4">
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(6)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Enrollment Year
                    </span>
            ...
            <div className="col-span-12 md:col-span-8 space-y-6">
              ...
              >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(11)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Middle Name
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(12)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Last Name
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(13)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Gender
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(14)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Blood Group
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(15)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Home Place
                    </span>
                    <span className="text-gray-800 font-medium mt-1">
                      {profileData?.home_place || "—"}
                    </span>
                  </div>
                </div>
                <div
                  className={`flex flex-col mt-4 ${getContentTransitionClass(
                    16
                  )}`}
                >
                  <span className="text-sm text-gray-500 font-medium">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
                  <div
                    className={`flex flex-col ${getContentTransitionClass(17)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Guardian Name
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(18)}`}
                  >
                    <span className="text-gray-800 font-medium mt-1">
                      {profileData?.guardian_ph_no || "—"}
                    </span>
                  ...
                  <div
                    className={`flex flex-col ${getContentTransitionClass(19)}`}
                  >
                    <span className="text-sm text-gray-500 font-medium">
                      Guardian Address
                    </span>
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-4">
                    <h4
                      className={`font-semibold text-gray-700 ${getContentTransitionClass(
                        21
                      )}`}
                    >
                    ...
                    <div
                      className={`flex flex-col ${getContentTransitionClass(
                        22
                      )}`}
                    >
                      <span className="text-sm text-gray-500 font-medium">
              ...
              <div className="flex justify-end">
                <button
                  onClick={handleShowModal}
                  className={`flex items-center py-3 px-6 bg-blue-600 text-white rounded-lg shadow-md hover:bg-blue-700 transition-all duration-300 hover:shadow-lg transform hover:-translate-y-1 ${getCardTransitionClass(
                    6
                  )}`}
                >
                  <PencilIcon alt={true} myStyle={"h-5 w-5 mr-2"} />
